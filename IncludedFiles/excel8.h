...
public:
	...
	void AutoFit();
	void AutoFormat(long Format, const VARIANT& Number, const VARIANT& CExcelFont, const VARIANT& Alignment, const VARIANT& Border, const VARIANT& Pattern, const VARIANT& Width);
	void AutoOutline();
...
/////////////////////////////////////////////////////////////////////////////
// CExcelPoint wrapper class

class CExcelPoint : public COleDispatchDriver
{
public:
	CExcelPoint() {}		// Calls COleDispatchDriver default constructor
	CExcelPoint(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcelPoint(const CExcelPoint& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
